package com.example.tintint_jw.View.Policy
...
import com.example.tintint_jw.Model.ModelPolicy
...
import android.graphics.PorterDuff.Mode.SRC_IN as SRC_IN1
...
class CheckPolicy02 : AppCompatActivity() {
    ...
    fun webviewSettings(){
        policy02.setVerticalScrollBarEnabled(true)
